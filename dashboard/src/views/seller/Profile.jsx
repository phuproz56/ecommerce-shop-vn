        ...
        <div className="w-full md:w-6/12">
          <div className="w-full p-4  bg-[#283046] rounded-md text-[#d0d2d6]">
            <div className="flex justify-center items-center py-3">
              ...
              >
                <img className="w-full h-full" src="../../assets/seller.png" alt="" />
              </label>{" "}
            ...
            <div className="px-0 md:px-5 py-2">
              <form onSubmit={add}>
                ...
                <button className="bg-blue-500 w-[190px] hover:shadow-blue-500/20 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3"></button>
              </form>{" "}
              :{" "}
              <div className="flex justify-between text-sm flex-col gap-2 p-4 bg-slate-800 rounded-md relative">
                <span className="p-[6px] bg-yellow-500 rounded hover:shadow-lg hover:shadow-yellow-500/50 absolute right-2 top-2 cursor-pointer">

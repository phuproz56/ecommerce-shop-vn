...
const AddProduct = () => {
  ...
  const [allBrand, setAllBrand] = useState(brands);
  ...
  const [cateShowBrand, setCateShowBrand] = useState(false);
            ...
            <div className="flex flex-col mb-3 md:flex-row gap-4 w-full text-[#d0d2d6]">
              ...
              <div className="flex flex-col w-full gap-1 relative">
                ...
                <input
                  ...
                  onChange={inputHandle}
                  value={brand}
                  onClick={() => setCateShowBrand(!cateShowBrand)}
                  type="text"
                ...
                <div
                  className={`absolute top-[101%] bg-slate-800 w-full transition-all ${
                    cateShowBrand ? "scale-100" : "scale-0"
                  }`}
                >
                  ...
                  <div className="flex justify-start items-start flex-col h-[150px] overflow-x-scroll">
                    {allBrand.map((c, i) => (
                      <span
                        key={i}
                        className={`px-4 py-2 hover:bg-indigo-500 hover:text-white hover:shadow-lg w-full cursor-pointer ${
                          brand === c.name && "bg-indigo-500"
                        }`}
                        onClick={() => {
                          setCateShowBrand(false);
                          setBrand(c.name);
                          setSearchValue("");
                          setAllBrand(brands);
                        }}
            ...
            <div className="flex flex-col mb-3 md:flex-row gap-4 w-full text-[#d0d2d6]">
              <div className="flex flex-col w-full gap-1 relative">
                ...
                >
                  ...
                  <div className="pt-14"></div>
                  <div className="flex justify-start z-9999 items-start flex-col h-[120px] overflow-x-scroll">
                    {allCategory.map((c, i) => (
                      <span
                        key={i}
                        className={`px-4 py-2 hover:bg-indigo-500 hover:text-white hover:shadow-lg w-full cursor-pointer ${
